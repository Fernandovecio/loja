<?php
    ...
    function fnAddCliente($nome, $foto, $email, $cpf) {
        $con = getConnection();
        
        
        $sql = "insert into cliente (nome, foto, email, cpf) values (:pNome, :pFoto, :pEmail, :pCpf)";
    ...
    function fnUpdateCliente($id, $nome, $foto, $email, $cpf) {
        $con = getConnection();
                
        $sql = "update cliente set nome = :pNome, foto = :pFoto, email = :pEmail, cpf = :pCpf where id = :pID";
