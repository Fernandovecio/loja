...
<body>
  ...
  <div class="col-6 offset-3">
    <fieldset>
      ...
      <form action="registraCliente.php" method="post" class="form" enctype="multipart/form-data">
        ...
        <div class="mb-3 form-group">
          <label for="arquivoId" class="form-label">Arquivo</label>
          <input type="file" name="arquivo" id="arquivoId" class="form-control" >
          <div id="helperArquivo" class="form-text">Importe seu arquivo</div>
        </div>
        <div class="mb-3 form-group">
        ...
        <div class="mb-3 form-group">
          ...
          <input type="text" name="cpf" id="cpfId" class="form-control" placeholder="Informe seu CPF" >
  ...
  <script src="util/upload.php"></script>
</body>
</html>